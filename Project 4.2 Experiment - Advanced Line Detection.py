...
def hls_select(img, thresh=(0, 255)):
    ...
    binary_output = cv2.add(binary_output,yellow)
    binary_output = cv2.add(binary_output,white)
    binary_output = cv2.add(binary_output,white_2)
    binary_output = cv2.add(binary_output,white_3)
